...
U růst cen potravin jsem porovnával průměrnou cenu celého koše všech potravin mezi jednotlivými roky - součet všech cen za jednotku všech kategorií a jejich meziroční změnu. U růstu mezd jsem pak porovnával prostý průměr souhrnně za všechna odvětví mezi jednotlivými roky. V žádném ze sledovaných let nedosáhl rozdíl mezi růstem cen a růstem mezd hodnoty větší než 10 %. Nejblíže se této hodnotě přiblížil rozdíl v roce 2008, kdy se změnily ceny potravin o zhruba -6.41 %, ale narostly ceny mezd o 3.07 %. Rozdíl tedy činil asi 9.48 %. Druhým rokem s největšími rozdílem v růstech cen a mezd byl rok 2012, kdy činil rozdíl 6.66 %.
### 5. Má výška HDP vliv na změny ve mzdách a cenách potravin? Neboli, pokud HDP vzroste výrazněji v jednom roce, projeví se to na cenách potravin či mzdách ve stejném nebo následujícím roce výraznějším růstem?
K zodpovězení této otázky jsem vyšel z procenta meziročního růstu/poklesu HDP na osobu (per capita). HDP je vhodnější vztahovat k jedné osobě dané ekonomiky, což odstraňuje výkyvy způsobené populačními změnami. Pro přesnější zodpovězení této otázky by bylo vhodné pracovat s korelačním koeficientem vyjadřujícím pevnost vztahu mezi změnami HDP a změnou v úrovni cen, platů/mezd. Nicméně i pouhým pohledem na výsledná data je zřejmé, že ve dvou ze třech let vyššího růstu HDP (2006 a 2016), případně v letech následujících docházelo také k vyšším nárůstům cen i mezd/platů. Konkrétně například v roce 2006, kdy byl růst HDP na osobu na úrovni 4.96 %, došlo v témže roce k růstu cen o 6.76 % a k růstu mezd/platů o 6.89 %, resp. v roce 2007 dokonce 6.18 % v cenách, resp. 7.69 % ve mzdách/platech. Podobný vývoj je vidět v roce 2016, kdy HDP rostlo o 4.89 %, ceny o 9.63 %, mzdy/platy o 6.17 % (v roce 2017 pak dokonce o 7.7 %). Naproti tomu je rok 2014 s růstem HDP na osobu 5.18 % (nejvyšší hodnota růstu HDP za sledované období). Přitom ale došlo k růstu cen "jen" o 3.27 % (v roce 2015 dokonce pokles o 1.19 %), a k růstu mezd jen o 2.6 % (v roce 2015 3.64 %). Celkově tedy asi nelze usuzovat na to, že by růst HDP byl plně spjat s růstem mezd/platů i cen. Vhodnější by asi bylo posoudit větší soubor dat za delší časové období a pro vícero zemí.
